...
@section('content')
        ...
        <div class="container mx-auto px-4">
            <div class="max-w-6xl mx-auto">
                <div class="text-center mb-12">
                    ...
                    <p class="text-gray-600 max-w-2xl mx-auto">Book guides and agencies with confidence. Always know
                            ...
                            <div class="space-y-4 mb-6">
                                <div class="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-600">Browse and book without any platform
                                            charges</p>
                                    </div>
                                </div>
                                <div class="flex items-start gap-3">
                                ...
                                <div class="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-600">Cancel up to 24 hours before (subject to
                                            guide/agency policy)</p>
                                    </div>
                                </div>
                                <div class="flex items-start gap-3">
                                    <i class="fa-solid fa-check text-green-500 mt-1"></i>
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-600">Your payment information is always
                                            protected</p>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="container mx-auto px-4">
            <div class="max-w-6xl mx-auto">
                <div class="text-center mb-12">
                    ...
                    <div class="w-24 h-1 bg-skyblue mx-auto mb-6"></div>
                    <p class="text-gray-600 max-w-2xl mx-auto">Join AroundUz and grow your business with our simple
                ...
                <div class="grid md:grid-cols-2 gap-8">
                    ...
                    <div class="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
                        ...
                        <div class="p-8">
                            ...
                            <a href="#"
                               class="block w-full bg-skyblue text-white text-center py-3 rounded-lg font-bold hover:bg-blue-600 transition-colors">
                                Become a Guide
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow border-2 border-skyblue">
                        ...
                        <div class="p-8">
                            ...
                            <a href="#"
                               class="block w-full bg-gradient-to-r from-purple-600 to-blue-600 text-white text-center py-3 rounded-lg font-bold hover:shadow-lg transition-all">
                                Register Agency
                            </a>
                        </div>
                    </div>
                ...
                <div class="mt-12 bg-white rounded-xl p-8 shadow-sm">
                    ...
                    <div class="grid md:grid-cols-3 gap-6 text-center">
                        <div>
                            ...
                            <p class="text-sm text-gray-600">Receive payments within 2-3 business days after tour
                                completion</p>
                        </div>
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-600">All payments processed through encrypted, secure
                                channels</p>
                        </div>
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-600">Track all your earnings with comprehensive financial
                                reports</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="space-y-4">
                    ...
                    @foreach($faqs as $index => $faq)
                        <div class="bg-gray-50 rounded-lg border border-gray-200 overflow-hidden">
                            <button onclick="togglePricingFAQ({{ $index }})"
                                    class="w-full text-left px-6 py-4 hover:bg-gray-100 transition-colors flex items-center justify-between">
                                ...
                                <i class="fa-solid fa-chevron-down text-gray-400 transition-transform duration-300"
                                   id="pricing-faq-icon-{{ $index }}"></i>
                            </button>
                            <div id="pricing-faq-answer-{{ $index }}"
    ...
    <section class="py-16 bg-gradient-to-r from-skyblue to-blue-500 text-white">
        <div class="container mx-auto px-4 text-center">
            ...
            <p class="text-lg md:text-xl opacity-90 mb-8 max-w-2xl mx-auto">Join our community of guides and agencies
                today</p>
