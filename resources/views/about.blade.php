...
@section('content')
    ...
    <section class="relative bg-gradient-to-r from-skyblue to-blue-500 text-white py-16 md:py-24 overflow-hidden">
        ...
        <div class="container mx-auto px-4 relative z-10">
            <div class="max-w-3xl mx-auto text-center">
                ...
                <p class="text-lg md:text-xl opacity-90">Connecting travelers with authentic Uzbekistan experiences
                    since 2020</p>
            </div>
        </div>
    </section>
        ...
        <div class="container mx-auto px-4">
            <div class="max-w-4xl mx-auto">
                ...
                <div class="grid md:grid-cols-2 gap-8 items-center mb-12">
                    <div>
                        <img src="https://images.unsplash.com/photo-1596422846543-75c6fc197f07?w=800" alt="Uzbekistan"
                             class="rounded-xl shadow-lg">
                    </div>
                    <div>
                        <h3 class="text-2xl font-bold text-gray-900 mb-4">Born from Passion for Travel</h3>
                        <p class="text-gray-700 mb-4 leading-relaxed">
                            AroundUz was founded in 2020 with a simple mission: to make authentic Uzbekistan travel
                            experiences accessible to everyone. We noticed that travelers often struggled to find
                            trustworthy local guides and reliable travel agencies.
                        </p>
                        <p class="text-gray-700 leading-relaxed">
                            Our platform bridges this gap by connecting curious travelers with verified local experts
                            who are passionate about sharing their culture, history, and hidden gems of Uzbekistan.
                        </p>
                    </div>
                </div>
                ...
                <div class="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-xl p-8 border-2 border-blue-100">
                    ...
                    <p class="text-gray-700 text-lg text-center leading-relaxed">
                        "To empower travelers with authentic local experiences while supporting local communities and
                        preserving the rich cultural heritage of Uzbekistan."
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="max-w-6xl mx-auto">
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                    <div class="bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow">
                        <div
                            class="w-16 h-16 bg-skyblue bg-opacity-10 rounded-full flex items-center justify-center mx-auto mb-4">
                        ...
                        <p class="text-gray-600 text-center text-sm">All guides and agencies are thoroughly verified to
                    ...
                    <div class="bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow">
                        ...
                        <p class="text-gray-600 text-center text-sm">Real local experiences, not tourist traps. Connect
                            with genuine culture and traditions.</p>
                    </div>
                    ...
                    <div class="bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow">
                        ...
                        <p class="text-gray-600 text-center text-sm">Supporting local guides and agencies while
                    ...
                    <div class="bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow">
                        ...
                        <p class="text-gray-600 text-center text-sm">Committed to providing exceptional service and
        ...
        <div class="container mx-auto px-4">
            <div class="max-w-6xl mx-auto">
                <div class="text-center mb-12">
                    ...
                    <div class="w-24 h-1 bg-skyblue mx-auto mb-6"></div>
                    <p class="text-gray-600 max-w-2xl mx-auto">Passionate individuals dedicated to revolutionizing
                        travel in Uzbekistan</p>
                </div>
                        ...
                        <div class="bg-white rounded-xl shadow-sm overflow-hidden hover:shadow-lg transition-shadow">
                            ...
                            <div class="p-6 text-center">
                                ...
                                <div class="flex justify-center gap-3">
                                    <a href="#"
                                       class="w-10 h-10 bg-gray-100 hover:bg-skyblue hover:text-white rounded-full flex items-center justify-center transition-colors">
    ...
    <section class="py-16 bg-gradient-to-r from-skyblue to-blue-500 text-white">
        <div class="container mx-auto px-4 text-center">
            ...
            <p class="text-lg md:text-xl opacity-90 mb-8 max-w-2xl mx-auto">Join thousands of travelers who have
                discovered authentic experiences through AroundUz</p>
