        ...
        <div class="container mx-auto px-4">
            <div class="text-center mb-12">
                <h1 class="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
                    <i class="fa-solid fa-envelope text-skyblue"></i> Contact Us
                </h1>
            ...
            <div class="bg-white rounded-2xl shadow-xl border border-gray-100 p-12 text-center">
                <div class="w-24 h-24 bg-skyblue bg-opacity-20 rounded-full flex items-center justify-center mx-auto mb-6">
                    <i class="fa-solid fa-headset text-skyblue text-5xl"></i>
                </div>
                <h2 class="text-2xl font-bold text-gray-900 mb-3">Contact Form Coming Soon</h2>
                <p class="text-gray-600 mb-6">We'll have a contact form ready for you soon!</p>
