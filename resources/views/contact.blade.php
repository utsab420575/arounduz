                ...
                <div class="grid lg:grid-cols-2 gap-12">
                    ...
                    <div class="bg-white rounded-xl shadow-sm p-8">
                        ...
                        <form onsubmit="handleContactSubmit(event)" class="space-y-6">
                            <div class="grid md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="text" name="first_name" required
                                           class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-skyblue focus:border-skyblue">
                                </div>
                                <div>
                            ...
                            <button type="submit"
                                    class="w-full bg-gradient-to-r from-skyblue to-blue-500 text-white py-3 rounded-lg font-semibold hover:shadow-lg transition-all duration-300">
                    ...
                    <div class="space-y-6">
                            ...
                            <div class="space-y-6">
                                <div class="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-600 text-sm">Amir Temur Street, 100000<br>Tashkent,
                                            Uzbekistan</p>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <a href="tel:+998711234567" class="text-skyblue hover:underline">+998 71 123 45
                                            67</a>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-600 text-sm">Monday - Friday: 9:00 AM - 6:00 PM<br>Saturday:
                                            10:00 AM - 4:00 PM<br>Sunday: Closed</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-gradient-to-br from-skyblue to-blue-500 rounded-xl shadow-sm p-8 text-white">
                            ...
                            <p class="mb-6 opacity-90 text-sm">Stay connected with us on social media for updates and
                                travel inspiration</p>
                            <div class="flex gap-3">
                                <a href="#"
                                   class="w-12 h-12 bg-white bg-opacity-20 backdrop-blur-sm rounded-lg flex items-center justify-center hover:bg-white hover:text-skyblue transition-all duration-300">
                        ...
                        <div class="bg-yellow-50 border-2 border-yellow-200 rounded-xl p-6">
                            ...
                            <p class="text-gray-600 text-sm mb-4">For immediate assistance, use our live chat or call
                                our hotline</p>
                            <button onclick="openLiveChat()"
                                    class="w-full bg-yellow-500 hover:bg-yellow-600 text-white py-2 rounded-lg font-semibold transition-colors">
                ...
                <div class="space-y-4">
                    ...
                    @foreach($faqs as $index => $faq)
                        <div class="bg-white rounded-lg border border-gray-200 overflow-hidden">
                            <button onclick="toggleContactFAQ({{ $index }})"
                                    class="w-full text-left px-6 py-4 hover:bg-gray-50 transition-colors flex items-center justify-between">
                                ...
                                <i class="fa-solid fa-chevron-down text-gray-400 transition-transform duration-300"
                                   id="contact-faq-icon-{{ $index }}"></i>
                            </button>
                            <div id="contact-faq-answer-{{ $index }}"
