...
<section class="relative bg-gradient-to-r from-skyblue to-blue-500 text-white py-16 md:py-20 overflow-hidden">
    ...
    <div class="container mx-auto px-4 relative z-10">
        <div class="max-w-3xl mx-auto text-center">
            ...
            <p class="text-lg md:text-xl opacity-90">Explore ancient cities, stunning architecture, and rich culture along the Silk Road</p>
        </div>
    </div>
</section>
    ...
    <div class="container mx-auto px-4">
        <div class="max-w-6xl mx-auto">
            <div class="text-center mb-12">
                ...
                <p class="text-gray-600 max-w-2xl mx-auto">Experience the magic of Uzbekistan's most iconic destinations</p>
            </div>
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-xl shadow-sm overflow-hidden hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
                    <div class="relative h-48 overflow-hidden">
                        <img src="{{ $destination['image'] }}" alt="{{ $destination['name'] }}" class="w-full h-full object-cover transform hover:scale-110 transition-transform duration-500">
                    ...
                    <div class="p-6">
                        ...
                        <a href="{{ route('guides') }}?location={{ $destination['name'] }}" class="mt-4 w-full bg-skyblue text-white py-2 rounded-lg font-semibold hover:bg-blue-600 transition-colors block text-center">
        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="grid md:grid-cols-2 gap-6">
                <div class="bg-blue-50 border-l-4 border-skyblue p-6 rounded-r-lg">
                    ...
                    <p class="text-gray-700 text-sm">Spring (April-May) and Autumn (September-October) offer pleasant weather perfect for exploring.</p>
                </div>
                ...
                <div class="bg-green-50 border-l-4 border-green-500 p-6 rounded-r-lg">
                    ...
                    <p class="text-gray-700 text-sm">Many nationalities can get visa-on-arrival or visa-free entry. Check requirements for your country.</p>
                </div>
                ...
                <div class="bg-purple-50 border-l-4 border-purple-500 p-6 rounded-r-lg">
                    ...
                    <p class="text-gray-700 text-sm">Uzbekistani Som (UZS). Cash is king, but cards are increasingly accepted in major cities.</p>
                </div>
                ...
                <div class="bg-yellow-50 border-l-4 border-yellow-500 p-6 rounded-r-lg">
                    ...
                    <p class="text-gray-700 text-sm">Uzbek is official, Russian widely spoken. English in tourist areas. Local guides help bridge the gap!</p>
                </div>
            </div>
        </div>
    </div>
...
<section class="py-16 bg-gradient-to-r from-skyblue to-blue-500 text-white">
    <div class="container mx-auto px-4 text-center">
        ...
        <p class="text-lg md:text-xl opacity-90 mb-8 max-w-2xl mx-auto">Connect with local guides who know these destinations inside out</p>
